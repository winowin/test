        ...
        <div class="card">
            <div id="box">
                ...
                <ul>
                    ...
                    <c:if test="${pageBean.totalPage==0}"><h2 style="color: #f8c78b">什么都没有找到，请重新搜索!</h2></c:if>
            ...
            <div class="center">
                <ul class="pagination">
                    ...
                    <li><a href="ShoppingFlowerServlet?action=searchPageFlowers&pageNum=${1}&search=${name}">首页</a></li>
                    <li><a href="ShoppingFlowerServlet?action=searchPageFlowers&pageNum=${pageBean.prePageNum}&search=${name}">«</a></li>
                    <c:if test="${pageBean.totalPage==0}">
                        <li  ><a id="nextPage"  href="ShoppingFlowerServlet?action=queryPageFlowers">»</a></li>
                        <li  ><a id="totalpage"  href="ShoppingFlowerServlet?action=queryPageFlowers">尾页</a></li>
                    </c:if>
                    <c:if test="${pageBean.totalPage!=0}">
                        <li  ><a   href="ShoppingFlowerServlet?action=searchPageFlowers&pageNum=${pageBean.nextPageNum}&search=${name}">»</a></li>
                        <li  ><a  href="ShoppingFlowerServlet?action=searchPageFlowers&pageNum=${pageBean.totalPage}&search=${name}">尾页</a></li>
                    </c:if>

                    <li><input type="hidden" id="jumpName" name="name" value="${name}"><input type="text" id="tPageNum" name="tPageNum" value="${pageBean.pageNum}" size="2"></li>
...
<script>
    $(function () {
        $("#jump").click(function (){
            ...
            location.href='ShoppingFlowerServlet?action=searchPageFlowers&pageNum='+tNum+'&search='+name;
        });
    });
</script>
</html>
