        ...
        <div class="card">
            ...
            <div class="center">
                <ul class="pagination">
                    ...
                    <li><a href="ShoppingFlowerServlet?action=queryPageFlowers&pageNum=${1}">首页</a></li>
                    <li><a href="ShoppingFlowerServlet?action=queryPageFlowers&pageNum=${pageBean.prePageNum}">«</a></li>
                    <li><a href="ShoppingFlowerServlet?action=queryPageFlowers&pageNum=${pageBean.nextPageNum}">»</a></li>
                    <li><a href="ShoppingFlowerServlet?action=queryPageFlowers&pageNum=${pageBean.totalPage}">尾页</a></li>
                    <li><input type="text" id="tPageNum" name="tPageNum" value="${pageBean.pageNum}" size="2"></li>
...
<script>
    $(function () {
        $("#jump").click(function (){
            ...
            location.href='ShoppingFlowerServlet?action=queryPageFlowers&pageNum='+tNum;
        });
    })
</script>
</html>
