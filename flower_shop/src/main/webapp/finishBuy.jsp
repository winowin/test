        ...
        $(function (){
            $.ajax({
                ...
                success:function (respDate){
                    ...
                    $("#ors").append(
                        "<img src='images/1.jpg' style='float: left;width: 90px;height: 90px;'>"+
                        "<div id='os'></div>"
                    );
                    ...
                    $('#subpay').attr('action','OrderServlet?action=finishBuy&orderid='+${orderid});
...
<div class="close_content">
    ...
    <div class="close_contenter">
        ...
        <div class="clear"></div>
        <h2>支付方式 </h2>
        <form method="post" id="subpay" action="">
